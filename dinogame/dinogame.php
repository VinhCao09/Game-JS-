...
<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    ...
    <div class="onlyforchrome" style="margin-top:5px;text-align:center;color:#8a8a8a;margin-bottom:80px; font-size:.8em;line-height:1.2em;font-family: Georgia;"><a href="http://www.thecodepost.org/internet/play-hidden-t-rex-game-offline-chrome/" target="_blank"><strong>T-Rex Dino game</strong></a> được cover lại từ Dinosaur Game của Google Chrome khi trình duyệt này bị mất kết nối internet. Truy cập kho game của chúng tôi tại <a href="https://www.vinhcaodatabase.com/vi/game.php" target="_blank"><strong>@menugame</strong></a>.<br/> Nhấn "Space" để Dino nhảy lên và bắt đầu game.</div>
